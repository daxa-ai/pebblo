...
def get_data(
    ...
    texts = [
        ...
        "Github Token is: ghp_hgu657yiujgwfrtigu3ver238765tyuhygvtrder6t7gyvhbuy5e676578976tyghy76578uygfyfgcyturtdf, AWS Access Key is: AKIAQIPT4PDORIRTV6PH  AWS Secret Key is : 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",
    ]
    ...
    if ids:
        # Unique ids for each text (md5 hash of text)
