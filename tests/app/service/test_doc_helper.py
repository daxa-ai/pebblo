...
def test_get_finding_details(loader_helper):
    ...
    loader_helper._get_finding_details(
        doc, data_source_findings, "entities", input_data
    )
...
def test_get_load_history(
    loader_helper, monkeypatch, mock_read_json_file_obj, mock_get_full_path_obj
):
    ...
    mock_read_json_file_obj.return_value = {
...
def test_get_doc_report_metadata(loader_helper):
    ...
    loader_helper._get_finding_details = MagicMock(
        return_value=get_finding_details_response
    )
