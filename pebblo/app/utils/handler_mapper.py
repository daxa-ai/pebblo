...
from pebblo.app.service.local_ui import local_ui_service as db_local_ui_service
...
def get_local_ui_api_handler(handler_name: str):
    try:
        ...
        handler_class = local_ui_api_handler_map.get(handler_name, {}).get(
            storage_type, None
        )
        if handler_class is None:
            raise ValueError(
