...
with redirect_stdout(StringIO()), redirect_stderr(StringIO()):
    from pebblo.app.routers.routers import api_v1_router_instance, router_instance, data_gov_router_instance
...
class Service:
    def __init__(self, config_details):
        ...
        self.app.include_router(data_gov_router_instance.router)
        # Adding cors
