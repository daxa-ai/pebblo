...
from langchain_core.models.safe_retriever import SemanticContext
...
class SafeRetrieverSemanticRAG:
    """
    Sample app to demonstrate the usage of PebbloSafeLoader, RetrievalQA and SafeRetriever
    ...
    def __init__(self, folder_id: str, collection_name: str):
        ...
        self.loader = PebbloSafeLoader(
            ...
            description="Semantic filtering using PebbloSafeLoader, RetrievalQA and SafeRetriever ",  # Description (Optional)
            load_semantic=True,
        )
    ...
    def ask(
        ...
        retriever = RetrievalQA.from_chain_type(
            llm=self.llm,
            chain_type="stuff",
            retriever=self.vectordb.as_safe_retriever(
